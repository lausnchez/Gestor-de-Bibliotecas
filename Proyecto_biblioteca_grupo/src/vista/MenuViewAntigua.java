 ...
 * @author Paula
 */
public class MenuViewAntigua extends javax.swing.JFrame {

    /**
     * Creates new form MenuView
     */
    public MenuViewAntigua() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuViewAntigua.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuViewAntigua().setVisible(true);
            }
        });
    }
