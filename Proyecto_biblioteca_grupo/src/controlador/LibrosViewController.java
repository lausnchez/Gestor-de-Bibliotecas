...
public class LibrosViewController implements ActionListener {
     ...
     private AgregarLibroAntigua agregarLibro;
     private JTable tbl_libros;
     private DefaultTableModel modeloTabla;

     public LibrosViewController(librosViewAntigua librosView, Libro libroModelo) {
    ...
    if (e.getSource() == this.librosView.getBtn_eliminar()) {
        ...
        if (idStr != null && !idStr.trim().isEmpty()) {
            ...
            AgregarLibroAntigua vistaAgregarLibro = new AgregarLibroAntigua();
